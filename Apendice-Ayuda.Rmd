...
Hablando de Google, siempre es una gran opcion para buscar ayuda o aprender conceptos nuevos de `R`. Páginas como StackOverflow o Github son excelentes recursos para aprender y entender más sobre `R`. 

## Ambiente R

Para trabajar con archivos es necesario tener la dirección absoluta o relativa (path) de estos, o bién indicarle a la sesión de `R` a qué directorio queremos que apunte. Esto se hace con la función `setwd()` y la dirección del directorio.

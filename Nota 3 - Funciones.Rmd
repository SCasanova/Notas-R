...
Nótese también que podemos definir valores por *default* para los parámetros. En este caso declaramos que `num2` es igual a 1 por default y por lo tanto, si el usuario no proporciona un valor para ese parámetro, la función puede correr con un valor predeterminado.

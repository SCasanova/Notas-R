...
Es el dato correspondiente a la primera fila y primera columna. Si solo proporcionamos un índice sin usar la coma, `R` regresa la columna que corresponda al indice.

...
El proceso para las listas en un poco diferente. Si intentamos hacer lo mismo, obtendremos una lista de un solo elemento que contiene al dato buscado, en lugar de el dato buscado pos si solo.

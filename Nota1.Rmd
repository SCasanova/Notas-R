...
Ahora que ya esta instalado R en la computadora, podemos hacer una prueba de uso. Localiza donde está guardado el programa y abrelo. Esto abrirá la consila de R dobnde se pueden iniciar a escribir comandos y recibir respuestas. En este ejemplo abrimos la consola y escribimos `print('Hello World')`. La consola nos regresa la imprsión "Hello World"
